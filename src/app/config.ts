export const googleRedirectUrl = `${process.env.BACKEND_DOMAIN}/auth/google/callback`;
export const googleClientId = process.env.GOOGLE_CLIENT_ID;
export const googleClientSecret = process.env.GOOGLE_CLIENT_SECRET;

export const lineRedirectUrl = `${process.env.BACKEND_DOMAIN}/auth/line/callback`;
...
export const facebookRedirectUrl = `${process.env.BACKEND_DOMAIN}/auth/facebook/callback`;
...
export const discordRedirectUrl = `${process.env.BACKEND_DOMAIN}/auth/discord/callback`;

export const githubClientId = process.env.GITHUB_CLIENT_ID;
export const githubClientSecret = process.env.GITHUB_CLIENT_SECRET;
export const githubRedirectUrl = `${process.env.BACKEND_DOMAIN}/auth/github/callback`;
...
export const twitterRedirectUrl = `${process.env.BACKEND_DOMAIN}/auth/twitter/callback`;
